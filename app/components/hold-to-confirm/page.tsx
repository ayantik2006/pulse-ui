          ...
          <div className="flex flex-col gap-5">
            <div className="w-full bg-neutral-900 border border-neutral-700 py-6 px-6 rounded flex flex-col gap-5 overflow-hidden">
              ...
              <div className="w-full max-w-full">
                <CodeBlockCommand
                  pnpm="pnpm dlx shadcn@latest add https://pulseui-henna.vercel.app/registry/HoldToConfirm.json"
                  yarn="yarn shadcn@latest add https://pulseui-henna.vercel.app/registry/HoldToConfirm.json"
                  npm="npx shadcn@latest add https://pulseui-henna.vercel.app/registry/HoldToConfirm.json"
                  bun="bunx --bun shadcn@latest add https://pulseui-henna.vercel.app/registry/HoldToConfirm.json"
                />
              </div>
