...
const card1Props = [
  ...
  },
  {
    ...
    type: "string",
    required: "false",
    description: "Name displayed over the image.",
  },
  {
    prop: "Designation",
    type: "string",
    required: "false",
    description: "Subtitle shown below the name on the image.",
  },
  {
    prop: "Tag",
    type: "string",
    required: "false",
    description: "Category tag shown in the text section.",
  },
  {
    prop: "Title",
    type: "string",
    required: "false",
    description: "Main heading in the text section.",
  },
  {
    prop: "Description",
    type: "string",
  ...
  },
  {
    ...
    type: "() => void",
    required: "false",
    description: "Callback fired when the heart button is clicked.",
  },
  {
    prop: "onMessage",
    type: "() => void",
    required: "false",
    description: "Callback fired when the message button is clicked.",
  },
  {
    prop: "onExternalLink",
    type: "() => void",
    required: "false",
    description: "Callback fired when the external link button is clicked.",
  },
  {
    prop: "className",
    type: "string",
    required: "false",
    description: "Additional CSS classes to style the card.",
  },
];
...
/>`}
          ...
          {/* card4 docs */}/{/* card5 docs */}/{/* card6 docs */}
          {/* <div>
                        <div className="w-full h-auto">
